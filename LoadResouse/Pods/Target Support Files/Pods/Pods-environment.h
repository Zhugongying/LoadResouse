...
// UMengSocialCOM
#define COCOAPODS_POD_AVAILABLE_UMengSocialCOM
#define COCOAPODS_VERSION_MAJOR_UMengSocialCOM 5
#define COCOAPODS_VERSION_MINOR_UMengSocialCOM 2
#define COCOAPODS_VERSION_PATCH_UMengSocialCOM 1
